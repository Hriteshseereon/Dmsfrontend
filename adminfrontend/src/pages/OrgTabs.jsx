  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-6">
      ...
      <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
        ...
        >
          <TabPane
            tab={<span className="text-3xl font-bold text-amber-700">Organizations</span>}
            key="1"
          >
            <OrganizationList />
          </TabPane>
          ...
          <TabPane
            tab={<span className="text-3xl font-bold text-amber-700">Customer</span>}
            key="2"
          >
            <CustomerApproval />
          </TabPane>
          ...
          <TabPane
            tab={<span className="text-3xl font-bold text-amber-700">Transport</span>}
            key="3"
          >
            <TransportApproval />
          </TabPane>
