...
const PendingPurchaseContractJSON = [
  {
    key: 1,
    slno: 1,
...
/* ---------------- COMPONENT ---------------- */
const PendingPurchaseContract = () => {
  const [dateRange, setDateRange] = useState(null);
    /* ---------------- MONTH FILTER LOGIC ---------------- */
const filteredData = useMemo(() => {
  return PendingPurchaseContractJSON.filter((rec) => {
      ...
      <Row justify="space-between" align="middle" className="mb-3">
        ...
        <Col>
          <h2 className="text-lg font-semibold text-amber-700">
            Pending Purchase Contracts
          </h2>
          <p className="text-amber-600 text-sm">
            Month-wise pending purchase contracts
          </p>
        </Col>
...
export default PendingPurchaseContract;
