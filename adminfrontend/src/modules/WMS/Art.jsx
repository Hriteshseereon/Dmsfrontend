...
export default function Art() {
          ...
          <EditOutlined
            ...
            onClick={async () => {
              ...
              try {
                ...
                console.error("Error fetching Art details for edit:", error);
  ...
  const exportCSV = () => {
    ...
    a.href = url;
    a.download = `art_records_${dayjs().format("YYYYMMDD_HHmmss")}.csv`;
    a.click();
  ...
  const renderFormFields = (form, disabled = false) => (
    <>
      <h6 className="text-amber-500">Art/ Lot Transaction</h6>
