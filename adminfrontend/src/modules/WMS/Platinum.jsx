...
export default function Platinum() {
  ...
  const fetchData = async () => {
    try {
      const response = await getWealthEntries({ asset_category: "PLATINUM" });
      ...
      console.error("Error fetching Platinum entries:", error);
          ...
          <EyeOutlined
            ...
            onClick={async () => {
              ...
              try {
                ...
                console.error("Error fetching Platinum details:", error);
          ...
          <EditOutlined
            ...
            onClick={async () => {
              ...
              try {
                ...
                console.error("Error fetching Platinum details for edit:", error);
  ...
  const exportCSV = () => {
    ...
    a.href = url;
    a.download = `platinum_records_${dayjs().format("YYYYMMDD_HHmmss")}.csv`;
    a.click();
  ...
  const renderFormFields = (form, disabled = false) => (
    <>
      <h6 className="text-amber-500">Platinum / Lot Transaction</h6>
  ...
  return (
    <div>
      ...
      <div className="border border-amber-300 rounded-lg p-4 shadow-md">
        <h2 className="text-lg font-semibold text-amber-700 mb-0">Platinum Transactions</h2>
        <p className="text-amber-600 mb-3">Track buying, selling, and valuation of platinum investments</p>
        <Table columns={columns} dataSource={filteredData} pagination={{ pageSize: 10 }} scroll={{ y: 300 }} />
      </div>

      {/* Add Modal */}
      <Modal
        title={<span className="text-amber-700 text-2xl font-semibold">Add Platinum Transaction</span>}
        open={isAddModalOpen}
        onCancel={() => {
        ...
        <Form
          ...
          onFinish={async (values) => {
            ...
            try {
              ...
              console.error("Error adding platinum entry:", error);
      ...
      {/* Edit Modal */}
      <Modal
        title={<span className="text-amber-700 text-2xl font-semibold">Edit Platinum Transaction</span>}
        ...
        <Form
          ...
          onFinish={async (values) => {
            ...
            try {
              ...
              console.error("Error updating platinum entry:", error);
      ...
      {/* View Modal */}
      <Modal
        title={<span className="text-amber-700 text-2xl font-semibold">View Platinum Transaction Details</span>}
