...
export default function Gold() {
  ...
  const renderFormFields = (form, disabled = false) => (
    <>
      <h6 className="text-amber-500">Gold / Lot Transaction</h6>
  ...
  return (
    <div>
      ...
      <div className="border border-amber-300 rounded-lg p-4 shadow-md">
        <h2 className="text-lg font-semibold text-amber-700 mb-0">Gold Transactions</h2>
        <p className="text-amber-600 mb-3">Track buying, selling, and valuation of gold investments</p>
      ...
      {/* Edit Modal */}
      <Modal
        title={<span className="text-amber-700 text-2xl font-semibold">Edit Gold Transaction</span>}
